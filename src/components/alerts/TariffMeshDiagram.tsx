...
export function TariffMeshDiagram() {
  ...
  const generateReport = () => {
    ...
    addText("• Layer 2: TITAN (Tariff Intelligence & Tactical Autonomous Node) - Orchestration engine", 10);
    ...
    addSection("TITAN (Tariff Intelligence & Tactical Autonomous Node)");
      ...
      <div className="flex justify-center mb-4">
        <Card className="w-96 p-6 bg-gradient-to-br from-primary/20 via-primary/10 to-accent/10 border-2 border-primary shadow-lg shadow-primary/20">
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold text-foreground">TITAN (Tariff Intelligence & Tactical Autonomous Node)</h3>
          </div>
